...
$Self->{'Frontend::Navigation'}->{'AgentDemoOTRS'}->{'002-DemoOTRS'} =  [
  {
    'AccessKey' => 'Currently at Step 4',
    'Block' => 'ItemArea',
    'Description' => 'Currently at Step 4',
    'Group' => [
      'users'
    ],
    'GroupRo' => [],
  ...
  },
  {
    ...
    'Group' => [],
    'GroupRo' => [],
    'Link' => 'Action=AdminGenericAgent;Subaction=Run;Profile=load%20step%2005;ChallengeToken=dYCUb0fj2OlNskvdnZM30B7uD2TIYLXa;',
    'LinkOption' => '',
    'Name' => 'Load Step 5',
    'NavBar' => 'DemoOTRS',
    'Prio' => '900',
