...
$Self->{Home} = '/opt/otrs';
    ...
    # ---------------------------------------------------- #
    # STEP 02 specific settings are here                   #
    # -----------------------------------------------------#
...
$Self->{'Frontend::Navigation'}->{'AgentDemoOTRS'}->{'002-DemoOTRS'} =  [
  {
    'AccessKey' => 'Currently at Step 2',
    'Block' => 'ItemArea',
    'Description' => 'Currently at Step 2',
    'Group' => [
      'users'
    ],
    'GroupRo' => [],
  ...
  },
  {
    ...
    'Group' => [],
    'GroupRo' => [],
    'Link' => 'Action=AdminGenericAgent;Subaction=Run;Profile=load%20step%2003;ChallengeToken=dYCUb0fj2OlNskvdnZM30B7uD2TIYLXa;',
    'LinkOption' => '',
    'Name' => 'Load Step 3',
    'NavBar' => 'DemoOTRS',
    'Prio' => '900',
