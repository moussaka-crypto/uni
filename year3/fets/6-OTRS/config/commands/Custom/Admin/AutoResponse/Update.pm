...
package Kernel::System::Console::Command::Custom::Admin::AutoResponse::Update;
...
sub Configure {
    ...
    $Self->Description('Update an auto response');
    # $Self->AddOption(
    #     Name        => 'option',
...
sub Run {
    ...
    $Self->Print("<yellow>Updating AutoResponse ...</yellow>\n");
    ...
    if (
        !$Kernel::OM->Get('Kernel::System::AutoResponse')->AutoResponseUpdate(
    ...
    {
        $Self->PrintError("Can't update auto response.");
        return $Self->ExitCodeError();
    }
