...
public:
	int get_LeftAngleX() const;
	int get_LeftAngleY() const;
	int get_RightAngleX() const;
	int get_RightAngleY() const;
	...
	MyRectangle();
	MyRectangle(int x1_copy, int y1_copy, int x2_copy, int y2_copy) : x1{ x1_copy }, y1{ y1_copy }, x2{ x2_copy }, y2{ x2_copy } {}
